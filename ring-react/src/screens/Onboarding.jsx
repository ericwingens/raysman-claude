...
import { ContactsPanel } from "../overlays/Contacts.jsx";
 ...
 */
export default function Onboarding({ ctx, done }) {
  ...
  return <Register ctx={ctx} step={step} setStep={setStep} finish={finish} />;
}
...
function Register({ ctx, step, setStep, finish }) {
